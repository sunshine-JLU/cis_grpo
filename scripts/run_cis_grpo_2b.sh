#!/usr/bin/env bash
# CIS-GRPO on Qwen2-VL-2B-Instruct (non-thinking) with ViRL39K,
# 4×RTX-4080-SUPER (32GB).
#
# V4 fmtonly config:
#   * reward_fn_nothink.py — format reward requires \boxed{...}
...
MODEL_PATH=${MODEL_PATH:-$PROJECT_ROOT/Qwen2-VL-2B-Instruct}
NNODES=${NNODES:-1}
...
experiment_name=${EXPERIMENT_NAME:-cis_grpo_qwen2_vl_2b_v1}
...
EXTRA=(
    ...
    # Disable vLLM V1 engine — flash_attn 2.8.3 has cu_seqlens_q CUDA bug with Qwen2-VL
    actor_rollout_ref.rollout.vllm_use_v1=0
)
